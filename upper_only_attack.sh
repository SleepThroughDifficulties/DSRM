CUDA=0
#MODEL_DIR="Date09061147_dsimdb_epochs10_seed46_meta1_clamp0.08"
MODEL_DIR="Date09051317_dsglue_epochs10_seed46_meta1_clamp0.1"
#MODEL_DIR=$1
...
do
  logfile=experiment_result/${MODEL_DIR}_${am}.log
